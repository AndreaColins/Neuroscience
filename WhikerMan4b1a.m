function varargout = WhikerMan4b1a(varargin)
...
% Last Modified by GUIDE v2.5 19-Aug-2016 10:35:51
...
%             r3all(handles.currentframe,:,:) = r3new;
    ...
    if handles.currentframe.h ~= handles.video.h.stopframe;
        % we're not in the final frame, so carry on
...
% initialise
handles.whisker(handles.current_whisker).tracked = zeros(1,handles.video.nframes);
handles.whisker(handles.current_whisker).r3all = zeros(handles.video.nframes,3,handles.n_control_pts);
handles.whisker(handles.current_whisker).fp3_all = zeros(handles.video.nframes,3);
handles.whisker(handles.current_whisker).kappa_all = zeros(handles.video.nframes,2);
handles.whisker(handles.current_whisker).theta_all = zeros(handles.video.nframes,2);
handles.whisker(handles.current_whisker).Emin = zeros(handles.video.nframes,1);
handles.whisker(handles.current_whisker).fpidx = zeros(handles.video.nframes,1);
% handles.whisker(handles.current_whisker).folliclemask = cell(handles.video.nframes,2);
...
if handles.Nwhiskers>1
    ...
    % reset
    handles.whisker(1).tracked = zeros(1,handles.video.nframes);
    handles.whisker(1).r3all = zeros(handles.video.nframes,3,handles.n_control_pts);
    handles.whisker(1).fp3_all = zeros(handles.video.nframes,3);
